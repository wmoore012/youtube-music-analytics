...
class TestNarrativeIntro:
    ...
    def test_artist_comparison_with_single_artist(self):
        ...
        result = narrative_intro(analysis_type="artist_comparison", context={"artists": ["Taylor Swift"]})
    ...
    def test_artist_comparison_with_multiple_artists(self):
        ...
        result = narrative_intro(
            analysis_type="artist_comparison", context={"artists": ["Drake", "The Weeknd", "Justin Bieber"]}
        )
...
class TestSectionTransition:
    ...
    def test_transition_with_key_insight(self):
        ...
        result = section_transition("overview", "comparison", key_insight=insight)
...
class TestChartContext:
    ...
    def test_chart_context_with_business_implications(self):
        ...
        result = chart_context("line_chart", what_to_look_for, business_implications)
...
class TestIntegration:
    ...
    def test_complete_narrative_flow(self):
        ...
        # Generate intro
        intro = narrative_intro("artist_comparison", context={"artists": ["Artist A", "Artist B"]})
        ...
        chart_help = chart_context(
            "bar_chart", ["Compare engagement rates", "Look for clear winners"], ["Invest in higher-engagement artists"]
        )
