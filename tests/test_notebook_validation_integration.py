...
class TestNotebookValidationIntegration:
    ...
    def test_notebook_cell_validation_workflow(self):
        ...
        cell_outputs = [
            ...
            pd.DataFrame({
                'artist': ['A', 'B', 'C'],
                'momentum_score': [0.7, 0.8, 0.6],
                'engagement_rate': [0.03, 0.04, 0.025]
            }),
        ...
        schemas = [
            {
                'type': 'dataframe',
                'columns': {'artist': 'object', 'views': 'int64'},
                'min_rows': 1
            },
            {
                'type': 'dataframe',
    ...
    def test_error_handling_and_reporting(self):
        ...
        try:
            ...
            range_result = self.output_validator.validate_score_range(
                problematic_data['momentum_score'], 0.0, 1.0
            )
    ...
    def test_performance_with_large_datasets(self):
        ...
        momentum_result = self.output_validator.validate_score_range(
            large_dataset['momentum_score'], 0.0, 1.0
        )
        
        engagement_result = self.output_validator.validate_score_range(
            large_dataset['engagement_rate'], 0.0, 0.2
        )
    ...
    def test_integration_with_existing_notebooks(self):
        ...
        notebook_content = {
            "cells": [
                {
                    "cell_type": "markdown",
                    "source": ["# Music Analytics Dashboard"]
                },
                {
                    "cell_type": "code",
                    "source": [
                ...
                },
                {
                    ...
                    "source": [
                        "# Load analytics data",
                        "df = pd.read_sql('SELECT * FROM artist_analytics', engine)"
                    ],
                    "outputs": [
                        {
                ...
                },
                {
                    ...
                    "source": [
                        ...
                        "scoring_results = calculate_momentum_scores(df)"
                    ],
                    "outputs": []
                }
            ],
...
class TestValidationResultMerging:
    ...
    def test_comprehensive_validation_pipeline(self):
        ...
        type_result = validator.validate_data_types(data, {
            'artist_name': 'object',
            'momentum_score': 'float64',
            'engagement_rate': 'float64',
            'growth_potential': 'float64'
