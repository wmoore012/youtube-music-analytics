...
class TestEnhanceChartBeauty:
    ...
    def test_enhance_plotly_chart(self):
        ...
        result = enhance_chart_beauty(mock_fig, title="Test Chart", emotional_theme="professional")
    ...
    def test_enhance_altair_chart(self):
        ...
        result = enhance_chart_beauty(mock_chart, title="Test Chart", emotional_theme="energetic")
...
class TestApplyColorScheme:
    ...
    def test_apply_custom_colors(self):
        ...
        custom_colors = {"Artist A": "#FF0000", "Artist B": "#00FF00"}

        result = apply_color_scheme(mock_fig, custom_colors=custom_colors, artists=["Artist A", "Artist B"])
...
class TestCreateChartAnnotations:
    ...
    def test_create_basic_annotations(self):
        ...
        insights = ["Artist A is trending upward", "Engagement peaked on weekends", "Comments show positive sentiment"]
...
class TestIntegration:
    ...
    def test_complete_chart_enhancement_workflow(self):
        ...
        # Apply color scheme
        artists = ["Artist A", "Artist B"]
        colored_fig = apply_color_scheme(mock_fig, scheme_name="vibrant", artists=artists)

        # Enhance beauty with annotations
        enhanced_fig = enhance_chart_beauty(
            colored_fig, title="Enhanced Chart", emotional_theme="professional", annotations=annotations
        )
    ...
    @patch.dict(
        os.environ,
        {"ARTIST_COLOR_SCHEME": "pastel", "ARTIST_COLORS_JSON": '{"Artist A": "#FF0000", "Artist B": "#00FF00"}'},
    )
