...
story_block(
        ...
        for section in self.sections:
            ...
            for cell in section["cells"]:
                if cell["cell_type"] == "markdown":
                    nb_cell = {"cell_type": "markdown", "metadata": {}, "source": [cell["source"]]}
    ...
    def create_artist_comparison_template(cls, config: NotebookConfig) -> StorytellingNotebook:
        ...
        notebook.add_section(
            "introduction", "Introduction & Overview", "intro", "Setting the stage for our artist comparison analysis"
        )

        notebook.add_section(
            "data_loading", "Data Loading & Preparation", "setup", "Loading and preparing YouTube data for analysis"
        )
        ...
        notebook.add_section(
            "engagement_analysis", "Engagement Deep Dive", "analysis", "Understanding audience engagement patterns"
        )

        if config.include_sentiment:
            notebook.add_section(
                "sentiment_analysis", "Sentiment Analysis", "analysis", "What fans are saying in the comments"
            )
