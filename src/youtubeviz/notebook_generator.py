...
class NotebookTemplateManager:
    ...
    def _build_chart_registry(self) -> Dict[int, Dict[str, Any]]:
        ...
        return {
            ...
            1: {
                "name": "Sentiment Breakdown by Artist",
                "function": "create_diverging_sentiment_bars",
                "module": "advanced_charts",
            },
            2: {
                "name": "Sentiment Model Categories Heatmap",
                "function": "create_sentiment_cluster_heatmap",
                "module": "advanced_charts",
            },
            3: {
                "name": "Top 3 Positive Theme Lollipops",
                "function": "create_positive_theme_lollipops",
                "module": "advanced_charts",
            },
            4: {
                "name": "Top 3 Negative Theme Lollipops",
                "function": "create_negative_theme_lollipops",
                "module": "advanced_charts",
            },
            5: {
                "name": "Standout Videos Scatter Plot",
                "function": "create_standout_videos_scatter",
                "module": "advanced_charts",
            },
            6: {
                "name": "Tour Compatibility Analysis",
                "function": "create_tour_compatibility_analysis",
                "module": "advanced_charts",
            },
            7: {
                "name": "UpSet Plot for Feature Intersections",
                "function": "create_upset_feature_intersections",
                "module": "advanced_charts",
            },
            8: {"name": "ISRC Balance Analysis", "function": "create_isrc_balance_bars", "module": "advanced_charts"},
            9: {
                "name": "Content Length Analysis",
                "function": "create_content_length_dumbbells",
                "module": "advanced_charts",
            },
            10: {"name": "Content Type Breakdown", "function": "create_content_type_dots", "module": "advanced_charts"},
            11: {
                "name": "Views by Category Over Time",
                "function": "create_views_by_category_areas",
                "module": "advanced_charts",
            },
            12: {
                "name": "Genre Context Heatmap",
                "function": "create_genre_context_heatmap",
                "module": "advanced_charts",
            },
            13: {
                "name": "Artist Rank Bump Chart",
                "function": "create_roster_rank_bump_chart",
                "module": "advanced_charts",
            },
            14: {
                "name": "Comment Polarity Ridgelines",
            ...
            18: {"name": "Top Positive Comments", "function": "extract_top_positive_comments", "module": "sentiment"},
            19: {"name": "Storytelling Dashboard", "function": "story_block", "module": "storytelling"},
            20: {"name": "Executive Summary", "function": "generate_executive_summary", "module": "summary_generator"},
        }

    def generate_notebook_template(
        self, notebook_name: str = "MusicScope™_Production_Dashboard", include_charts: Optional[List[int]] = None
    ) -> Dict[str, Any]:
        """
        ...
        # Add header cell
        notebook["cells"].append(self._create_header_cell(notebook_name, len(include_charts)))

        # Add imports cell
        notebook["cells"].append(self._create_imports_cell())
        ...
        for chart_id in include_charts:
            if chart_id in self.chart_registry:
                ...
                notebook["cells"].extend(self._create_chart_cells(chart_id, chart_info))

        # Add final validation cell
        notebook["cells"].append(self._create_validation_cell(len(include_charts)))

        return notebook

    def _create_header_cell(self, notebook_name: str, chart_count: int) -> Dict[str, Any]:
        """Create notebook header cell."""
        return {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
    ...
    def _create_imports_cell(self) -> Dict[str, Any]:
        """Create imports cell with all required functions."""
        return {
            "cell_type": "code",
    ...
    def _create_data_loading_cell(self) -> Dict[str, Any]:
        """Create data loading cell with real data only."""
        return {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {},
            ...
            "source": [
                ...
                "        required_cols = ['sentiment_category', 'daily_views', 'engagement_rate', 'has_isrc', 'content_type']\n",
    ...
    def _create_chart_cells(self, chart_id: int, chart_info: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Create markdown and code cells for a chart."""
        cells = []

        # Markdown cell
        cells.append(
            {"cell_type": "markdown", "metadata": {}, "source": [f"## Chart {chart_id}: {chart_info['name']}\n"]}
        )
        ...
        cells.append(
            {
                ...
                "outputs": [],
                "source": [
                    f"print('🎨 Generating Chart {chart_id}: {chart_info['name']}...')\n",
                    "\n",
                    "try:\n",
                    "    if not df.empty:\n",
    ...
    def _create_validation_cell(self, total_charts: int) -> Dict[str, Any]:
        """Create final validation cell that counts working charts."""
        return {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {},
    ...
    def generate_and_save_notebook(
        self,
        filepath: str,
        notebook_name: str = "MusicScope™_Production_Dashboard",
        include_charts: Optional[List[int]] = None,
    ) -> None:
        """Generate and save a complete notebook."""
        notebook = self.generate_notebook_template(notebook_name, include_charts)
        self.save_notebook(notebook, filepath)
...
def create_production_notebook(output_path: str = "notebooks / MusicScope™_Production_Dashboard.ipynb") -> None:
    ...
    manager.generate_and_save_notebook(
        ...
        notebook_name="MusicScope™ Production Dashboard",
