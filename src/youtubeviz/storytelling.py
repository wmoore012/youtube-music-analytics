...
def narrative_intro(
    ...
    if analysis_type == "artist_comparison":
        ...
        intros = [
            f"🎵 **The Music Data Detective Story** 🕵️‍♀️\n\nWelcome to the fascinating world where music meets data science! Today we're diving deep into the YouTube performance of {
            ...
            f"🚀 **From Bedroom Studios to Billboard Charts** 📈\n\nEvery chart - topping artist started somewhere, and YouTube has become the modern equivalent of playing local venues. We're analyzing {
            ...
            f"💡 **The Algorithm Whisperers** 🤖\n\nIn today's music industry, understanding YouTube's algorithm is as important as understanding chord progressions. We're examining how {
