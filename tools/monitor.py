...
Examples:
  ...
  python tools/monitor.py --full-check     # Complete system check
    ...
    parser.add_argument('--consistency', action='store_true',
                       help='Run artist consistency validation')
    parser.add_argument('--quality', action='store_true',
                       help='Full data quality report')
    parser.add_argument('--etl-status', action='store_true',
                       help='ETL pipeline status and history')
    ...
    try:
        ...
        from src.icatalogviz.data import qa_artist_consistency_check, qa_nulls_and_orphans
...
def check_data_quality(engine, verbose):
    ...
    from src.icatalogviz.data import qa_nulls_and_orphans
