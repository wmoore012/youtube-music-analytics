...
Examples:
  ...
  python tools/etl.py --dry-run           # Test without changes
    ...
    # Pipeline options
    parser.add_argument("--focused", action="store_true", help="Run focused ETL (core data only, faster)")
    parser.add_argument("--comprehensive", action="store_true", help="Run comprehensive ETL (all features)")
    parser.add_argument("--sentiment", action="store_true", help="Include sentiment analysis")
    parser.add_argument("--channels", type=str, help="Comma-separated list of channels to process")
