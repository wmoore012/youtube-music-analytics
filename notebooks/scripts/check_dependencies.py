...
Usage:
    python notebooks/scripts/check_dependencies.py
    python notebooks/scripts/check_dependencies.py --auto-install
"""
...
def main():
    ...
    if essential_ok:
        ...
        if not optional_ok:
            print("Some optional packages missing (not critical)")
        print("=" * 60)
        print()
        print("You can now run: python notebooks/scripts/create_dashboard.py")
        print()

        if AUTO_INSTALL_AVAILABLE:
            print("Pro tip: Run with --auto-install to install missing packages automatically")
            print("   python notebooks/scripts/check_dependencies.py --auto-install")
        print()
    else:
        print("=" * 60)
