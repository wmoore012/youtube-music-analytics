#!/usr/bin/env python3
"""
Smoke Test for MusicScope™ Notebook Modules

Tests that all 3 notebook modules can:
...
Run from project root:
    python3 notebooks/scripts/test_notebook_modules.py
"""
...
# Setup path: add project root so tools/ is importable
...
try:
    from tools.notebook_helpers.musicscope_design_system import (
...
# ============================================================================
# TEST 2: Import Notebook Modules
# ============================================================================
print("\n" + "=" * 80)
print("TEST 2: Import Notebook Modules")
print("=" * 80)
...
try:
    from tools.notebook_helpers.musicscope_sentiment import render_sentiment_section, categorize_sentiment
...
def _build_minimal_comments_df() -> pd.DataFrame:
    ...
    # Add sentiment_category with the same guardrails as production notebooks
...
print("\n✅ All notebook modules are production-ready for notebook integration.")
print("\nNext steps:")
